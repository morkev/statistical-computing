...
Counting the number of rain drops in the inscribed circle of radius equal to the length of the field. 
The ratio of the number of drops in the circle to the total number of drops gives $\pi$.
"""
...
def rain(number_of_drops=100, length_of_field=1, plot=True, format='pdf', dynamic=False):
    """
